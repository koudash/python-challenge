...
def passage_analysis(filename):
    ...
    with open(txt_path, "r") as txtfile:
        ...
        # Note that the above syntax might introduce at most two (could be more than two if passages have more than one paragraph) "" at 
            # both beginning and ending of passages, e.g. start and end with quotation marks
